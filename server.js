...
app.get('/totalCollectionLength/:contentType', function (req, res, next) {
    switch (req.params.contentType) {
        ...
        case ('Roles'): requestHandler.RolesTotalCollectionLength(req, res);
            break;
        case ('Records'): requestHandler.RecordsTotalCollectionLength(req, res);
            break;
...
app.get('/Records/:viewType', function (req, res) {
    var data = {};
    for (var i in req.query) {
        data[i] = req.query[i];
    }
    var viewType = req.params.viewType;
    switch (viewType) {
        case "form": requestHandler.getRecordsById(req, res, data);
            break;
        default: requestHandler.getFilterRecords(req, res);
            break;
    }
...
app.post('/addClass', function (req, res) {
    var data =  req.body;
    requestHandler.addClass(req, res, data);
});

app.post('/deleteClass', function (req, res){
    var data =  req.body;
    requestHandler.deleteClass(req, res, data);
});
...
app.get('/getInstructor', function(req,res){
    if(req.query.code){
...
app.get('/getInstructorNew', function(req,res){
    if(req.query.code){
        var data = req.query.code;
        requestHandler.getInstructorByCodeNew(req, res, data);
    }
...
app.get('/getRate', function(req,res){
    requestHandler.getRate(req,res);
});

app.get('/getRateByInstructorCode/:code', function(req, res){
    var data = req.param('code');
    requestHandler.getRateByInstructorCode(req, res, data);
});
...
app.get('/getRole', function(req,res){
    requestHandler.getRole(req,res);
});

app.post('/addRole', function (req, res) {
    var data =  req.body;
    requestHandler.addRole(req, res, data);
});

app.post('/deleteRole', function (req, res){
    var data =  req.body;
    requestHandler.deleteRole(req, res, data);
});

app.post('/updateRole', function (req, res){
    var data =  req.body;
    requestHandler.updateRole(req, res, data);
});


//----------------------Teaching_Record---------------------------------------------
app.get('/getTeachingRecord', function(req, res){
    if(req.query.code){
...
app.post('/getTeachingRecordByDateRange', function(req, res){
    var data = req.body;
    requestHandler.getTeachingRecordByDateRange(req, res, data);
});

app.post('/getTeachingRecordByMonth', function(req, res){
    var data = req.body;
    requestHandler.getTeachingRecordByMonth(req, res, data);
});

app.post('/addTeachingRecord', function (req, res) {
    var data =  req.body;
    requestHandler.addTeachingRecord(req, res, data);
});

app.post('/updateTeachingRecord', function (req, res){
    var data =  req.body;
    requestHandler.updateTeachingRecord(req, res, data);
});

app.post('/deleteTeachingRecord', function (req, res){
    var data =  req.body;
    requestHandler.deleteTeachingRecord(req, res, data);
});
