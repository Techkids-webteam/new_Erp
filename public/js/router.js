  ...
  'common'
    ...
    var appRouter = Backbone.Router.extend({
        ...
        testContent: function (contentType) {
            var arrayOfContentTypes = ['Persons', 'Companies', 'Leads', 'Opportunities', 'Projects', 'Tasks', 'Employees', 'Applications', 'JobPositions0', 'JobPositions', 'Birthdays', 'Departments', 'Users', 'Profiles'];
