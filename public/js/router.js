  ...
  'common'
    ...
    var appRouter = Backbone.Router.extend({
        ...
        testContent: function (contentType) {
            var arrayOfContentTypes = ['Persons', 'Companies', 'Leads', 'Opportunities', 'Projects', 'Tasks', 'Employees', 'Applications', 'CLASS', 'Roles', 'Records', 'Reports', 'TeacherAssignments','JobPositions', 'Birthdays', 'Departments', 'Users', 'Profiles'];
