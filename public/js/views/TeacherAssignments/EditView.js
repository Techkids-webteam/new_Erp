define([
    "text!templates/TeacherAssignments/EditTemplate.html",
    "collections/TeacherAssignments/TeacherAssignmentsCollection",
    ...
    function (EditTemplate, TeacherAssignmentsCollection, DepartmentsCollection, WorkflowsCollection, AssigneesView, Custom, common, populate) {
        var EditView = Backbone.View.extend({
            ...
            initialize: function (options) {
				...
				this.currentModel.urlRoot = "/TeacherAssignments";
                this.responseObj = {};
                this.render();
            },
        ...
        //         var department = this.$("#departmentDd").data("id");
            ...
            render: function () {
                ...
                this.$el = $(formString).dialog({
                    autoOpen: true,
                    resizable: false,
                    dialogTeacherAssignments: "edit-dialog",
                    width: "900",
                    title: "Edit TeacherAssignments",
                    buttons: [
						{
                            text: "Save",
