define([
    "text!templates/Roles/EditTemplate.html",
    ...
    function (EditTemplate, RolesCollection, DepartmentsCollection, WorkflowsCollection, AssigneesView, Custom, common, populate) {
        var EditView = Backbone.View.extend({
            ...
            initialize: function (options) {
				...
				this.currentModel.urlRoot = "/Roles";
                this.responseObj = {};
                this.render();
            },
            ...
            changeTab:function(e){
                var holder = $(e.target);
                holder.closest(".dialog-tabs").find("a.active").removeRoles("active");
                holder.addRoles("active");
                var n= holder.parents(".dialog-tabs").find("li").index(holder.parent());
                var dialog_holder = $(".dialog-tabs-items");
                dialog_holder.find(".dialog-tabs-item.active").removeRoles("active");
                dialog_holder.find(".dialog-tabs-item").eq(n).addRoles("active");
            },
